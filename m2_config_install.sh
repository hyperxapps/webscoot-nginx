...
GITHUB_REPO_API_URL="https://api.github.com/repos/hyperxapps/webscoot-nginx/contents/magento2"
...
curl -o /etc/nginx/fastcgi_params https://raw.githubusercontent.com/hyperxapps/webscoot-nginx/master/magento2/fastcgi_params
curl -o /etc/nginx/nginx.conf https://raw.githubusercontent.com/hyperxapps/webscoot-nginx/master/magento2/nginx.conf
