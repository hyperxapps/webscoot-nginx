...
NGINX_EXTRA_CONF_URL="https://raw.githubusercontent.com/hyperxapps/webscoot-nginx/master/magento1/conf_m1/"
...
wget -qO /etc/nginx/fastcgi_params https://raw.githubusercontent.com/hyperxapps/webscoot-nginx/master/magento1/fastcgi_params
wget -qO /etc/nginx/nginx.conf https://raw.githubusercontent.com/hyperxapps/webscoot-nginx/master/magento1/nginx.conf

sed -i "s/www/sites-enabled/g" /etc/nginx/nginx.conf

mkdir -p /etc/nginx/sites-enabled
mkdir -p /etc/nginx/sites-available && cd $_
wget -q https://raw.githubusercontent.com/hyperxapps/webscoot-nginx/master/magento1/sites-available/default.conf
wget -q https://raw.githubusercontent.com/hyperxapps/webscoot-nginx/master/magento1/sites-available/magento1.conf
